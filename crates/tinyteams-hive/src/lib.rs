...
//!
//! `tinyteams-hive` adds the one thing a shared desk cannot do on its own:
...
//!   [`MentionTurnQueue`] ports `tinyteams` already defines.
...
//! [`Selector`]: tinyteams::Selector
//! [`MentionTurnQueue`]: tinyteams::MentionTurnQueue
//!
//! # Modules
//!
